...
<head>
    ...
    <title> <?php echo $html->uc_site_title(); ?> </title>

    <!-- Include CSS -->
    <link href="<?php echo ONECOM_UC_DIR_URL ?>assets/css/bootstrap.min.css" rel="stylesheet">
    <link href="<?php echo ONECOM_UC_DIR_URL ?>themes/theme-2/style.css" rel="stylesheet">

    <!-- Include JS -->
    <script src="<?php echo ONECOM_UC_DIR_URL ?>assets/js/jquery.min.js"></script>
    <script src="<?php echo ONECOM_UC_DIR_URL ?>assets/js/script.js"></script>
    ...
    <style>
        ...
        <?php
        if (strlen($uc_option_data['uc_primary_color'])) { ?>.ocuc-page .newsletter .content .btn {
            ...
            <main>
                <div class="row">
                    <div class="col-md-12 col-lg-8 ocuc-content-box">
                        ...
                        <?php
                        if ($uc_option['uc_timer_switch'] === 'on') { ?>
