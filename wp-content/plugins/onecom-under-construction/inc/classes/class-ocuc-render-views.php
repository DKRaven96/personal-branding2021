...
class OCUC_Render_Views
{
    ...
    {
        $uc_option = self::get_uc_option();
        $uc_page_bg_image = isset($uc_option['uc_page_bg_image']) ? $uc_option['uc_page_bg_image'] : '';
    ...
    {
        $uc_option = self::get_uc_option();
        return nl2br($uc_option['uc_description']);
    }
    ...
    {
        $uc_option = self::get_uc_option();
        return strip_tags($uc_option['uc_description']);
    }
